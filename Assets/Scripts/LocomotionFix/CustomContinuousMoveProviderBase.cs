...
public class CustomContinuousMoveProviderBase : LocomotionProvider
{
    ...
    private TerrainGravity terrainG;

    private void Start()
    {
        terrainG = GetComponent<TerrainGravity>();
    }
    ...
    protected void Update()
    {
        ...
        var newPos = transform.position + translationInWorldSpace;
        var newHeightFix = terrainG.getHeight();
        if (newHeightFix - newPos.y > terrainG.MaxStepHeight)
            return;
